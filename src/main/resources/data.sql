...
INSERT INTO group_buy (
  ...
  (2, '✨ 부르르 제로사이다 올킬 ✨','부르르 제로사이다, 250ml, 30개',
    ...
    0,0,0,'OPEN', NULL, 1,'2025-05-21 10:00:00','2025-05-21 10:00:00'),
  ( 3, '🍜 짜라짜라짜짜짜 짜파게티 정품 🍜',   '짜파게티 140g, 40개',
     '40개 대용량 팩으로 면치기 끝판왕 도전🕺',
      ...
      0,0,0,'CLOSED', NULL, 1,'2025-05-21 11:00:00','2025-05-21 11:00:00'),
  ( 4, '김치전 꼬다리맛 입덕하세요!','동원 양반 김치맛 김부각 50g, 16개',
    ...
    TRUE, NULL, '2025-05-21 12:00:00','카카오테크 교육장','2025-05-24 17:00:00',
